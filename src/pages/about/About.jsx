        ...
        <main className="main">
            <div className="container">
                <div className="about-div text-center">
                    <div className="row">
                        <div className="about-img-div d-none d-lg-block col-lg-6">
                            <img src="../public/media/about-style.jpg" alt="3 bracelets, presented with a black background" className="img-fluid about-img" />
                        </div>
                        <div className="about-section col-12 col-lg-6">
                            ...
                            <p className="about-text"> Please contact me directly at <a className="contact-link" href="tel:123-456-7890">601-201-8688</a></p>
                            <p>or email me at: <a className="contact-link" href="mailto: franriddellrenaissance@gmail.com">franriddellrenaissance@gmail.com.</a></p>
